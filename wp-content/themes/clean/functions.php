...
function clean_setup() {
	...
	register_nav_menus(
		[
			'main-menu' => esc_html__( 'Primary', 'clean' ),
		]
	);
...
add_image_size( 'home_post', 644, 562, true);
...
function clean_scripts() {
	...
	wp_enqueue_style( 'clean-fonts-roboto', 'https://fonts.googleapis.com/css?family=Roboto:400,300,100,500');
	wp_enqueue_style( 'clean-fonts-slab', 'https://fonts.googleapis.com/css?family=Roboto+Slab:400,300,100,500');
	...
	wp_enqueue_script( 'jquery-easing', get_template_directory_uri() . '/assets/js/jquery.easing.1.3.js', ['jquery'], '' , true);
	wp_enqueue_script( 'bootstrap', get_template_directory_uri() . '/assets/js/bootstrap.min.js', ['jquery'], '', true);
	wp_enqueue_script( 'jquery-waypoints', get_template_directory_uri() . '/assets/js/jquery.waypoints.min.js', [], '', true);
	wp_enqueue_script( 'clean-index', get_template_directory_uri() . '/assets/js/index.js', [], '', true);
